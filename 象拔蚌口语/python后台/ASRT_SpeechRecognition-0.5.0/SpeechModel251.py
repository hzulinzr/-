...
from readdata25 import DataSpeech as DataSpeech_ashiell2
...
class ModelSpeech(): # 语音模型类
	...
	def CreateModel(self):
		...
		# 将前一层的激活值重新规范化，使输出数据的均值接近0，标准差接近1
		layer_h1 = BatchNormalization()(layer_h1)

		#layer_h1 = Dropout(0.05)(layer_h1)
		layer_h2 = Conv2D(32, (3,3), use_bias=True, activation='relu', padding='same', kernel_initializer='he_normal')(layer_h1) # 卷积层
		layer_h3 = MaxPooling2D(pool_size=2, strides=None, padding="valid")(layer_h2) # 池化层
		#layer_h3 = BatchNormalization(axis=2, momentum=0.99, epsilon=0.001, center=True, scale=True)(layer_h3)
		...
		#layer_h6 = BatchNormalization(axis=2, momentum=0.99, epsilon=0.001, center=True, scale=True)(layer_h6)
	...
	def TestModel(self, datapath='', str_dataset='dev', data_count = 32, out_report = False, show_ratio = True, io_step_print = 10, io_step_file = 10):
		...
		if(str_dataset=='test'):
			data = DataSpeech_ashiell2(self.datapath, str_dataset)
		else:
